...
checkpoint_file = './work_dirs/cascade_rcnn_x101_64x4d_fpn_20e_coco/latest.pth'
model = init_detector(config_file,checkpoint_file,device='cuda:0')

import cv2
import matplotlib.pyplot as plt

img = '/opt/ml/mmdetection/data/simple_test/test_img3.png'
...
show_result_pyplot(model,img,results,palette=([255,0,255],))
print("finish")
